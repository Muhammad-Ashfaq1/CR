...
<div class="cst-page-header">
    <div>
        <h1 class="cst-page-title">Expense Breakdown Report</h1>
        <p class="cst-page-subtitle">Granular report of all materials and site expenses by category and project.</p>
    </div>
...
<div class="row g-3 mb-4">
    <div class="col-md-4">
        <div class="cst-card cst-stat-card border-primary">
            <div class="cst-stat-label text-primary fw-bold">Total Expense Amount</div>
            <div class="cst-stat-value text-primary fs-3 fw-bold">PKR {{ number_format($totalAmount, 0) }}</div>
            <div class="cst-stat-sub text-muted">{{ $expenses->count() }} line items</div>
        </div>
    </div>
    <div class="col-md-8">
        <div class="cst-card p-3">
                ...
                @forelse($categoryBreakdown as $b)
                    ...
                    <div class="col-sm-6 col-md-4">
                        <div class="p-2 border rounded bg-light">
                            ...
                            <div class="fw-bold fs-6 mt-1">PKR {{ number_format($b['total'], 0) }}</div>
                ...
                <tbody>
                    @forelse($expenses as $exp)
                        <tr>
                            ...
                            <td>
                                <div class="fw-semibold">{{ $exp->vendor ?? '—' }}</div>
