    ...
    <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
        <div>
            <h4 class="pos-glass-intro-title mb-1">
                <i class="icon-base ti tabler-receipt me-2 text-primary"></i> Record Direct Site Expense
            </h4>
            <div class="pos-glass-intro-sub">Record material purchases, machinery rentals, fuel, utilities, or site petty cash.</div>
        </div>
        <div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12 text-end border-top pt-3">
                            <button type="submit" class="btn btn-primary">
                                <i class="icon-base ti tabler-check me-1"></i> Save Expense
                            </button>
                        </div>
                    </div>
                </form>
