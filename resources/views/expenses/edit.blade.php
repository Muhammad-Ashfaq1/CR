...
<div class="cst-page-header">
    <div>
        <h1 class="cst-page-title">Edit Expense #{{ $expense->id }}</h1>
        <p class="cst-page-subtitle">Update project expense amount, category, or receipt voucher.</p>
    </div>
    <div>
            ...
            <div class="cst-card-body p-4">
                <form action="{{ route('expenses.update', $expense) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <label class="form-label">Replace Receipt / Bill File</label>
